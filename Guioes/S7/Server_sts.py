...
def main():
    # Carregar a chave privada e pública do servidor
    ...
    # Assinar e enviar a chave pública do servidor ao cliente
    ...
    # Receber a chave pública do cliente e a assinatura do cliente
    # Aqui, por simplicidade, suponhamos que o servidor já tenha a chave pública do cliente e a assinatura

    # Verificar a assinatura da chave pública do cliente
    if verify_signature(client_public_key, client_public_key_bytes, client_signature):
        print("Assinatura do cliente verificada com sucesso!")
    else:
        print("Falha ao verificar a assinatura do cliente.")
    ...
    # Usar a chave compartilhada para comunicação segura com o cliente
